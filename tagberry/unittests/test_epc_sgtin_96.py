...
class SGTIN96Test(unittest.TestCase):
    ...
    def test_parse_epc_uri(self):
        ...
        str(self._company_prefix), str(self._indicatorDigit) + str(self._itemRef), str(self._serial_number))
        factory = EPCFactory()
    ...
    def test_parse_tag_uri(self):
        ...
        str(self._filter), str(self._company_prefix), str(self._indicatorDigit) + str(self._itemRef),
