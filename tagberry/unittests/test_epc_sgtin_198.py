...
class SGTIN96Test(unittest.TestCase):
    ...
    def test_encode(self):
        ...
        sgtin96 = self._sgtin198.encode(companyPrefix=self._companyPrefix,
        ...
        partitionValue = partitions.getPartitionValue(len(self._companyPrefix), "SGTIN198")
    ...
    def test_parse_epc_uri(self):
        ...
        str(self._companyPrefix), str(self._indicatorDigit) + str(self._itemRef), str(self._serialNumber))
        factory = EPCFactory()
    ...
    def test_parse_tag_uri(self):
        ...
        tagUri = "urn:epc:tag:sgtin-96:%s.%s.%s.%s" % (
        str(self._filter), str(self._companyPrefix), str(self._indicatorDigit) + str(self._itemRef),
        str(self._serialNumber))
        factory = EPCFactory()
    ...
    def _checkBitsAndHex(self, epc):
        ...
        filterValue = bits[epc.getField("Filter").getOffset():int(epc.getField("Filter").getOffset()) + int(
            epc.getField("Filter").getBitLength())]
        self.assertEquals(int(filterValue, 2), int(self._filter))

        partitionValue = bits[epc.getField("Partition").getOffset():int(epc.getField("Partition").getOffset()) + int(
            epc.getField("Partition").getBitLength())]
