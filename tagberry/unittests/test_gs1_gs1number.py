...
class GS1NumberTest(unittest.TestCase):
    ...
    def test_is_valid(self):
        ...
        with self.assertRaises(NotImplementedError) as cm:
            gs1.is_valid("")
        exception_raised = cm.exception
        self.assertIsInstance(exception_raised, NotImplementedError,
                              "Incorrect exception raised from GS1Number.is_valid")
    ...
    def test_to_epc(self):
        ...
        exception_raised = cm.exception
        self.assertIsInstance(exception_raised, NotImplementedError,
                              "Incorrect exception raised from GS1Number.test_to_epc")
    ...
    def test_get_app_identifiers(self):
        ...
        exception_raised = cm.exception
        self.assertIsInstance(exception_raised, NotImplementedError,
                              "Incorrect exception raised from GS1Number.test_get_app_identifiers")
    ...
    def test_to_base_number(self):
        ...
        exception_raised = cm.exception
        self.assertIsInstance(exception_raised, NotImplementedError,
                              "Incorrect exception raised from GS1Number.to_base_number")
