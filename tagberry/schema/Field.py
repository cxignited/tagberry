...
class Field(object):
    ...
    def __init__(self, fieldName=None, offset=None, bitLength=None, ordinal=None, fieldValue=None, digitLength=None,
                 isPadded=False):
    ...
    def __repr__(self):
        return "{0}:{1}:{2}:{3}:{4}:{5}".format(self._ordinal, self._fieldName, self._fieldValue, self._bitLength,
                                                self._offset, self._digitLength)
